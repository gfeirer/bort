...
This is a modified version of "Bort":http://github.com/fudgestudios/bort/tree to suit our needs.
...
* Fork this project when starting a new one. In this way you will be able to merge in changes made to bort later on.
* Edit the database.yml and the settings.yml files
* Change the default password in the bort migration
* Change the session_key and secret token in config/environment.rb. 
* Edit the REST_AUTH_SITE_KEY in each of the environment files
** This require re-encrypt the passwords in spec/fixtures/users.yml after migrations
** script/console test
** u = User.find_by_login "each_user_in_spec/fixtures/users.yml"
** u.encrypt "each_password_in_spec/fixtures/users.yml"
** change the correct encrypted passwords in spec/fixtures/users.yml
* Install the required gems:
** [sudo] gem install rspec rspec-rails cucumber
** [sudo] gem install term-ansicolor treetop diff-lcs nokogiri (To install nokogiri you will need to have the libraries libxml-dev libxslt-dev)
** [sudo] gem install selenium-client
** [sudo] gem install thoughtbot-factory_girl -s http://gems.github.com
* Rake db:migrate
...
This fork has some additional work has been done by "Aentos":http://www.aentos.com/
